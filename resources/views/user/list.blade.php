        ...
        <div class="container">
           ...
           <div class="row">
            <div class=" col-lg-12 mb-3">
                <h2 class="maintitle"> List User </h2>
            </div>  
            </div> 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                       <div class=" card1  " >
                        <div class="row justify-content-between align-items-center px-4">
                            <h5 class="col-6  card-header">All User   </h5>
                            <div class="col-6 text-end">
                                 <button class="btn btn-success"  data-bs-toggle="modal" data-bs-target="#addUserModel">
                                    Add user <i class="fa fa-plus"></i></button>   
                            </div>
                        </div>
